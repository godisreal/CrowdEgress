...
class GUI(object):
    ...
    def __init__(self, FN_FDS=None, FN_EVAC=None):
        ...
        self.notebook.add(self.frameSoc,text="SocialGroup")
        ...
        self.showHelp(self.spin_socialforce, "Select the different formula of social force: \n 0: Traditional social force; 1: Extended social force; 2: Group social force.  ")  #Uncheck it if you do not know what it means.")
        ...
        self.buttonExitProb = Button(self.frameData, text='Read output files and plot the door selection probablity', command=self.selectOutTxtFile)
    ...
    def selectOutTxtFile(self):
        #tempdir=os.path.dirname(self.fname_EVAC)
        #print(tempdir)
        self.fname_OutTXT = tkf.askopenfilename(filetypes=(("txt files", "*.txt"),("All files", "*.*")), initialdir=self.currentdir)
    ...
    def selectOutNPZ(self):
        ...
        self.fname_OutNPZ = tkf.askopenfilename(filetypes=(("npz files", "*.npz"),("All files", "*.*")), initialdir=os.path.dirname(self.fname_EVAC))
        ...
        show_crowdfluid(self.fname_OutNPZ)
